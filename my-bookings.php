...
// Get bookings
$stmt = $con->prepare("SELECT b.booking_id AS BookingID, b.booking_date AS BookingDate, b.status AS Status, b.total_amount AS TotalAmount, m.title AS Title, s.show_time AS ShowTime, c.cinema_name AS CinemaName, c.city AS City
                       FROM booking b
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    Status: <span class="badge badge-<?php echo $booking['Status'] == 'Confirmed' ? 'success' : ($booking['Status'] == 'Pending' ? 'warning' : 'danger'); ?>"><?php echo $booking['Status']; ?></span>
                                </p>
